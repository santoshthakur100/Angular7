...
BABYLON.SceneLoader.Load("", "assets/3d/babylon5.babylon", engine, function (scene) {

    //var camera = new BABYLON.ArcRotateCamera("ArcRotateCamera", 13, 14, 10, new BABYLON.Vector3(0, 0.5, 0), scene);
    var camera = new BABYLON.ArcRotateCamera("ArcRotateCamera", 0, 0, 0, new BABYLON.Vector3(0, 0.5, 0), scene);
    camera.speed = 0.1;
...
//         skeleton.beginAnimation("Idale",true);
...
//                 console.dir("assets/", "animations.babylon");
//                 skeleton.copyAnimationRange(skelMesh[0].skeleton, "Idale");
